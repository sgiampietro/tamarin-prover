...
prettyNonGraphSystem se = vsep $ map combine_ -- text $ show se
  ...
  , ("Secret",           text $ show $ L.get sBasis se)
  , ("Leaked",        text $ show $ L.get sNotBasis se)
  , ("Assumed NoCanc",  text $ show $ L.get sNoCanc se)
...
instance Apply LNSubst System where
    apply subst (System a b b1 b2 b5 c d e f g h i j k l m) =
...
instance HasFrees System where
    foldFrees fun (System a b b1 b2 b5 c d e f g h i j k l m) =
    ...
    foldFreesOcc fun ctx (System a _b _b1 _b2 _b5 _c _d _e _f _g _h _i _j _k _l _m) =
    ...
    mapFrees fun (System a b b1 b2 b5 c d e f g h i j k l m) =
...
compareSystemsUpToNewVars
   (System a1 b1 bb1 bb2 b5 c1 d1 e1 f1 g1 h1 i1 j1 k1 l1 False)
   (System a2 b2 b21 b22 bb5 c2 d2 e2 f2 g2 h2 i2 j2 k2 l2 False)
       = if compareNodes == EQ then
            compare (System M.empty b1 bb1 bb2 b5 c1 d1 e1 f1 g1 h1 i1 j1 k1 l1 False)
                (System M.empty b2 b21 b22 bb5 c2 d2 e2 f2 g2 h2 i2 j2 k2 l2 False)
         else
            compareNodes
        where
