...
dhmultIntruderRules = [
    ...
    , Rule PubGConstrRule [] [outFact $ fAppdhOne] [kdhFact fAppdhOne, kLogFact fAppdhOne] []
    , Rule PubGConstrRule [] [outFact $ fAppdhZero] [kdhFact fAppdhZero, kLogFact fAppdhZero] []
