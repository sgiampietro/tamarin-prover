...
dhmultIntruderRules = [
    ...
    , Rule FreshNZEConstrRule [freshDHFact x_fresh_var] [kuFact x_fresh_var, outFact x_fresh_var] [ kuFact x_fresh_var,  kuFact (fAppdhExp (gname, x_fresh_var)) , kdhFact x_fresh_var]         []
    ...
    , Rule PubGConstrRule [] [outFact $ fAppdhOne] [kdhFact fAppdhOne, kLogFact fAppdhOne, kuFact (fAppdhExp (gname, fAppdhOne)), kLogFact (fAppdhExp (gname, fAppdhOne))] []
    , Rule PubGConstrRule [] [outFact $ fAppdhZero] [kdhFact fAppdhZero, kLogFact fAppdhZero, kuFact (fAppdhExp (gname, fAppdhZero)), kLogFact (fAppdhExp (gname, fAppdhZero))] []
